        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(double_null(DynamicMonitoringSummary::CpuUsage))
                    .col(double_null(DynamicMonitoringSummary::GpuUsage))
                    ...
                    .col(double_null(DynamicMonitoringSummary::LoadOne))
                    .col(double_null(DynamicMonitoringSummary::LoadFive))
                    .col(double_null(DynamicMonitoringSummary::LoadFifteen))
                    .col(big_integer_null(DynamicMonitoringSummary::Uptime))
                    .col(big_integer_null(DynamicMonitoringSummary::BootTime))
                    .col(big_integer_null(DynamicMonitoringSummary::ProcessCount))
                    ...
                    .col(big_integer_null(DynamicMonitoringSummary::TcpConnections))
                    .col(big_integer_null(DynamicMonitoringSummary::UdpConnections))
